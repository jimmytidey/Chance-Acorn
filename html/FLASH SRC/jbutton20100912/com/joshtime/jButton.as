package com.joshtime {
	...
	public class jButton extends Sprite
	{
		...
		public function jButton(label:String, color:int = 0xbbddff, width:int = 200, height:int = 40, textY:int = 2, fontSize:Number = 24, font:String = "Arial", fontColor:int = 0x333333):void {
